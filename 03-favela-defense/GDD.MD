...
### 1. Start Screen (2 seconds - Auto-advance)
- Display game title "FAVELA DEFENSE"
- Show starting resources: 5 units, 3 barricades
- **Transition**: Auto-fade to Game Screen with brief tutorial overlay
